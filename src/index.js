...
import {Guide, Step, ContentPosition} from "./Guide/Guide"
//let ContentPosition, Guide, Step =  require("./Guide/Guide");
//let GuideRenderer = require('./Guide/GuideRenderer');
...
ReactDOM.render(<GuideRenderer guide={guide} onStart={() => console.log('Start')} onEnd={() => console.log('End')}
                               onNextStep={() => console.log('Next')}
                               onPrevStep={() => console.log('Prev')}/>, document.getElementById('root'));
