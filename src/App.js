...
import './App.css';
import {ContentPosition, Guide, ToolTipPlacement} from "./Guide/Guide";
...
function App(props) {
    return (
        <div className="App">
            <Button onClick={() => {
                guide.setActive(!guide.getActive());
                props.updateGuide(guide);
                props.setBackgroundColor('white');
            }} variant="contained" id={'test1'}
...
export default GuideWrapper(App, {
    guide,
